...
String message = (String)request.getAttribute("message");
	...
	if(username==null){
		...
		if(method.equals("upemployee")){
			id=request.getParameter("id");
			List jlist = cb.get1Com("select * from employee where id='"+id+"'",13);
...
<table class="table table-bordered"> 
     ...
     <td><input type="text" name="number" class="span4" value="<%=number %>" required/></td> 
     </tr>
     <tr>
