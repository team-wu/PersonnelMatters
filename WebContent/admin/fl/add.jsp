...
<div class="title_right"><strong>分类信息管理</strong></div>  
<div style="width:900px;margin:auto;">
<form action="<%=basePath %>ComServlet" method="post" name="form1">
<table class="table table-bordered"> 
     <tr><input type="hidden" name="method" value="<%=method%>" /> 
     <td width="40%" align="right" nowrap="nowrap" bgcolor="#f1f1f1">分类信息：</td>
     <td><input type="text" name="departmentName" class="span4" required/></td> 
     </tr> 
     <tr>
