...
<div class="title_right"><strong>高级用户管理</strong></div>  
...
<%String word=Common.toChineseAndTrim(request.getParameter("word")); 
	...
	List pagelist1 = cb.getMessage(Integer.parseInt(page1),"select * from admin where username like '%"+word+"%' and sf!='管理员' order by id desc",10);
