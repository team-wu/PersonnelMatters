...
<div class="title_right"><strong>信息管理</strong></div>  
...
<table class="table table-bordered"> 
     ...
     <td width="40%" align="right" nowrap="nowrap" bgcolor="#f1f1f1">信息审核：</td>
     ...
     <tr>
     <td width="40%" align="right" nowrap="nowrap" bgcolor="#f1f1f1">审核意见：</td>
     <td><input type="text" name="opinion" class="span4" required/></td> 
     </tr>
