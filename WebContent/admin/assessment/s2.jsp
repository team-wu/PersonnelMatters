...
<form action="<%=basePath %>admin/assessment/s2info.jsp" method="post" name="form1">
<table class="table table-bordered">
	 <tr>
     <td align="center" nowrap="nowrap" bgcolor="#f1f1f1">考核内容：<input type="text" name="word" class="span3" required/></td> 
     </tr> 
     <tr>
