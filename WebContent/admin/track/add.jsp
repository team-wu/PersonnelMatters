...
String message = (String)request.getAttribute("message");
	...
	if(username==null){
		...
		String id="";String number="";String workContent=""; 
		if(method.equals("upgz")){
			id=request.getParameter("id");
			List jlist = cb.get1Com("select * from track where id='"+id+"'",4);
...
<table class="table table-bordered"> 
    ...
    <%if(method.equals("upgz")){ %><option value="<%=number%>"><%=number%></option> <%} %> 
    ...
    <%}} %>
     ...
     <tr>
     <td width="40%" align="right" nowrap="nowrap" bgcolor="#f1f1f1">记录内容：</td>
